...
if(sys.argv[1] == "-h"):
    ...
    exit();
arguments = dict();
acceptable_arguments = ['name', 'source_mod', 'njobs', 'n_neighbors', 'classifier_choice'];
...
if('n_neighbors' in arguments): n_neighbors = int(arguments['n_neighbors']);
...
## Train Classifier
###############################
classifier = KNeighborsClassifier(n_jobs=NJOBS, n_neighbors=n_neighbors);
...
#################################
hyperstring = "";
hyperparamlist = ['delta_mod', 'source_mod', 'NJOBS', 'n_neighbors', 'classifier_choice' ];
